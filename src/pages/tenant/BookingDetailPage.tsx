...
import { ArrowLeftIcon, CalendarIcon, PersonIcon, CardStackIcon, HomeIcon } from '@radix-ui/react-icons';
          ...
          <div style={sectionStyle}>
            ...
            <div style={villaImagesStyle} className={'villa-images'}>
              ...
              <div style={sideImagesContainerStyle} className={'side-images-3rd'}>
                ...
                />
                <img
                    src={villa.images[4] || villa.images[0]}
                    alt={villa.name}
                    style={sideImageStyle}
                    onClick={() => navigate(`/villas/${villa.id}`)}
                />
        ...
        <div>
          ...
          <div style={sectionStyle}>
            ...
            <div style={detailItemStyle}>
              ...
              <span style={detailValueStyle}>{user?.name}</span>
            </div>
            <div style={detailItemStyle}>
